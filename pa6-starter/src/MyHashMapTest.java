...
public class MyHashMapTest {
	...
	public void testPutGet() {
		String key = "newkey";
		testMap.put(key, TEST_VAL);
		List<String> resultKeys = testMap.keys();
		System.out.println(resultKeys);
		assertEquals(TEST_VAL, testMap.get(key));
	}
	
	@Test
	public void testPutGetNullVal3() {
		String key = "newkey";
		testMap.put(key, null);
		List<String> resultKeys = testMap.keys();
		System.out.println("t3 " + resultKeys);
		assertEquals(null, testMap.get(key));
	}
	
	@Test
	public void testPutNV() {
		String key = "newkey";
		boolean b = testMap.put(key, null);
